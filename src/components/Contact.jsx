    ...
    <section id="contact" className="py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <form action="https://formspree.io/f/xanykyqb" method="POST" className="grid grid-cols-1 gap-3">
          <input name="name" placeholder="MOHD SAAD" className="p-2 rounded theme-border-full theme-bg-secondary theme-text-primary" required/>
          <input name="email" placeholder="msaadm96@gmail.com" className="p-2 rounded theme-border-full theme-bg-secondary theme-text-primary" type="email" required/>
          <textarea name="message" placeholder="To Contact Please Send Message" className="p-2 rounded theme-border-full theme-bg-secondary theme-text-primary" rows="5" required/>
