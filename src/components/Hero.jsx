  ...
  return (
    <section className="py-12">
      <div className="max-w-4xl mx-auto text-center">
        <img src={profileImage} alt="Mohd Saad" className="w-32 h-32 rounded-full mx-auto mb-4 object-cover theme-border-profile"/>
        ...
        <div className="mt-4 space-x-3">
          <a href={resumePdf} download className="px-4 py-2 rounded transition-all duration-200 hover:opacity-80 theme-border-full inline-block theme-text-primary">Download Resume</a>
